...
These errors can vary by region. **<u>Map users should undertake their own accuracy assessments that are relevant to their area and application of interest</u>**. To better understand the nature of such errors, how they can be detected, and in some cases, corrected, please refer to [Xiong et al (2026)](https://www.cabidigitallibrary.org/doi/10.31220/agriRxiv.2026.00464). The methods include details on how to use polygon shape metrics, which are provided with our geoparquets, to detect fields that are under-segmented and bias-correct their areas.   
