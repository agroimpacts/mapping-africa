...
An example of how to view the data (using a Jupyter notebook) is available [here](https://agroimpacts.github.io/mapping-africa/index.html?lat=40.7128&lon=-74.0060&zoom=12
).
